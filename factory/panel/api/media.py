...
def add_topics(
    ...
    return Added(
        ...
        what_next=(
            ...
            # Тема добавлена — но пост из неё делает воркер. Без этой приписки
            # владелец добавляет тему, видит бодрое подтверждение и не дожидается
            # поста: поймано живьём, ровно как с перерисовкой картинки.
            + (
                " Пост по ней появится, когда воркер её возьмёт."
